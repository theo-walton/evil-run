...
SideBlock::SideBlock(void)
{
	_squares[20] = 1; _squares[21] = 1; _squares[22] = 1; _squares[23] = 1; _squares[24] = 1;
	_squares[15] = 0; _squares[16] = 0; _squares[17] = 0; _squares[18] = 0; _squares[19] = 0;
	_squares[10] = 0; _squares[11] = 0; _squares[12] = 2; _squares[13] = 0; _squares[14] = 0;
	_squares[5]  = 0; _squares[6]  = 0; _squares[7]  = 0; _squares[8]  = 0; _squares[9]  = 0;
...
float	SideBlock::Orientation(void)
{
	return 0;
}
